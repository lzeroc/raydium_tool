...
export async function deposit(
  ...
  if (!connection || !publicKey) throw new Error('Miss connection')
  ...
  return await sendTransaction(connection, publicKey, transaction, signers, account)
}
...
export async function depositV4(
  ...
  return await sendTransaction(connection, wallet, transaction, signers, account)
}
